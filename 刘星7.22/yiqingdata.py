...
class downdata:
    def __init__(self):
        self.url1 = "https://voice.baidu.com/newpneumonia/get?target=trend&isCaseIn=1&stage=publish&callback=jsonp_1595391957467_83486"
        self.url2 = "https://voice.baidu.com/newpneumonia/get?target=trend&isCaseIn=0&stage=publish&callback=jsonp_1595399699107_64784"
        user_agents = [
    ...
    def deal_with_foreign(self,basedata):
        ...
        sql = sql = """select count(*) from lplzdwin"""  
        cursor.execute(sql)
        print("连接数据库成功")
        cursor.close()
        conn.close()
    ...
    def foreign_run(self):
        base_data1 = self.get_url(self.url1)[26:-2]
